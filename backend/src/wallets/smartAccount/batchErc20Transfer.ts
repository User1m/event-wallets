...
import { ERC20_ABI, getVerifyingPaymaster, getSimpleAccount, getGasFee, printOp, getHttpRpcClient } from '../helpers';
...
export default async function main(config: IConfig, tkn: string, t: Array<string>, amt: string, withPM: boolean) {
