...
const goerliUrl = process.env.GOERLI_INFURA_URL;
// if (!goerliUrl) {
//   throw new Error('GOERLI_INFURA_URL is undefined');
// }

const mumbaiUrl = process.env.MUMBAI_INFURA_URL;
// if (!mumbaiUrl) {
//   throw new Error('MUMBAI_INFURA_URL is undefined');
// }

const baseUrl = process.env.BASE_INFURA_URL;
// if (!baseUrl) {
//   throw new Error('BASE_INFURA_URL is undefined');
// }
